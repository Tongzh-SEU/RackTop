...
3. 创建同版本的 GitHub Release，正式可用版本应标记为 Latest；测试版本才使用 Pre-release。
4. Release 标题必须包含产品名和版本号，例如 `RackTop v1.24.1`。
5. Release 说明应依据 `docs/VERSION_INFOS.md` 和 `docs/Version_overview.md` 编写，至少包含主要更新、验证结果、下载说明和已知限制。
