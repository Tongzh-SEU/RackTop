...
| 平台 | 安装包 | 下载 |
| --- | --- | --- |
| macOS Apple Silicon | `RackTop-1.25.2-macos-arm64-unsigned.dmg` | [下载 macOS 版本](https://github.com/Tongzh-SEU/RackTop/releases/download/v1.25.2/RackTop-1.25.2-macos-arm64-unsigned.dmg) |
